...
public class Recibo {
    ...
    // Datos de la declaración del pago
    ...
    private String detalleUnidad; // Torre - Piso - TipoElemento
    ...
    public int getUsuarioResponsableId() { return usuarioResponsableId; }
    public void setUsuarioResponsableId(int usuarioResponsableId) { this.usuarioResponsableId = usuarioResponsableId; }
    ...
    public String getDniResidente() { return dniResidente; }
    public void setDniResidente(String dniResidente) { this.dniResidente = dniResidente; }
    public String getDetalleUnidad() { return detalleUnidad; }
    public void setDetalleUnidad(String detalleUnidad) { this.detalleUnidad = detalleUnidad; }
