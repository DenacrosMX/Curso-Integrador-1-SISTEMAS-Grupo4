...
export default function PrototipoCondominios() {
  ...
  const incidencias = [
    {
      id: "#INC-101",
      titulo: "Fuga de agua en sótano",
      estado: "En proceso",
      prioridad: "Alta",
    },
    {
      id: "#INC-102",
      titulo: "Luz pasillo torre B",
      estado: "Pendiente",
      prioridad: "Media",
    },
    {
      id: "#INC-103",
      titulo: "Ascensor torre A",
      estado: "Resuelto",
      prioridad: "Alta",
    },
    {
      id: "#INC-104",
      titulo: "Puerta del garaje",
      estado: "Pendiente",
      prioridad: "Baja",
    },
  ];
  ...
  const comunicados = [
    {
      ...
      detalle: "Se realizará el viernes a las 6:00 p. m.",
    },
    {
      titulo: "Reunión de junta directiva",
      detalle: "Sábado a las 10:00 a. m. en el salón comunal.",
    },
    {
      titulo: "Recordatorio de pago",
      detalle: "La cuota de mantenimiento vence el día 30.",
    },
  ];
        ...
        <main className="col-span-12 md:col-span-9 lg:col-span-10 p-4 md:p-8">
          <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            ...
            <div className="flex gap-3 flex-wrap">
              <button className="bg-white rounded-2xl px-4 py-2 shadow-sm">
                Exportar
              </button>
              <button className="bg-slate-900 text-white rounded-2xl px-4 py-2 shadow-sm">
                Nueva acción
              </button>
            </div>
          </header>
        ...
        <div className="w-full max-w-5xl grid md:grid-cols-2 bg-white rounded-3xl shadow-xl overflow-hidden">
          <div className="bg-slate-900 text-white p-10 flex flex-col justify-center">
            ...
            <p className="text-slate-300 text-base leading-7">
              Plataforma web para la gestión digital de condominios y edificios
              residenciales.
            </p>
  ...
  if (screen === "pagos") {
    return (
      <Layout
        ...
        subtitle="Control de cuotas, pagos realizados y morosidad de residentes"
      >
        <div className="bg-white rounded-2xl shadow-sm p-5 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <button className="bg-slate-900 text-white rounded-2xl px-4 py-3">
              Registrar pago
            </button>
          </div>
        </div>
              ...
              <tbody>
                {pagos.map((p) => (
                  <tr key={p.depto} className="border-b last:border-0">
                    ...
                    <td className="py-3 font-medium">{p.monto}</td>
                    <td className="py-3">
                      <button className="text-sm bg-slate-100 px-3 py-2 rounded-xl">
                        Ver detalle
                      </button>
                    </td>
                  </tr>
  ...
  if (screen === "incidencias") {
    return (
      <Layout
        ...
        subtitle="Registro, seguimiento y estado de reclamos o problemas del condominio"
      >
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-5">
            ...
            <div className="space-y-4">
              ...
              ></textarea>
              <button className="w-full bg-slate-900 text-white rounded-2xl py-3">
                Guardar incidencia
              </button>
            </div>
          </div>
  ...
  if (screen === "comunicados") {
    return (
      <Layout
        title="Módulo de Comunicados"
        subtitle="Gestión de avisos y mensajes dirigidos a los residentes"
      >
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          <div className="xl:col-span-2 bg-white rounded-2xl shadow-sm p-5">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-5">
            ...
            <div className="space-y-4">
              ...
              />
              <textarea
                className="w-full border rounded-2xl px-4 py-3 h-36"
  ...
  return (
    <Layout
      ...
      subtitle="Consulta general de usuarios, departamentos y estado dentro del sistema"
    >
      <div className="bg-white rounded-2xl shadow-sm p-5">
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
