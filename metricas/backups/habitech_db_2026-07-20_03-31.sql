...
\restrict 8bRhCDJzcdxGcV3eVeQ01zpZlOYFreLTu4ZrPZcbf5k8RiggJqU0hInj0v0s4eH
...
CREATE TABLE public.asignaciones (
    ...
    codigo_unidad_especifica character varying(30) NOT NULL,
...
COPY public.asignaciones (id, usuario_id, inventario_maestro_id, codigo_unidad_especifica, tipo_adquisicion, precio_mensual_pactado, estado, fecha_ingreso, fecha_salida) FROM stdin;
1	6	23230	DPTO-401	PROPIETARIO	2000.00	ACTIVO	2026-07-18	\N
\.
...
1	1	Mantenimiento General	Cosas para arreglar	GLOBAL	\N	INFORMATIVO	PUBLICADO	2026-07-08 22:37:17.110859+00	\N
\.
...
1	Los Parques de villa	Av. 1 de mayo	10094245930	12451235346345	5	2026-07-02 01:51:39.74261+00	ACTIVO
\.
...
1	1	Mantenimiento Mensual Estándar Base	2000.00
\.
...
1	1	7	AGUA SALIENDO POR LA PUERTA	Agua saliendo de la puerta del Dpto 401	ALTA	RESUELTO	2026-07-19 02:17:16.628455+00	2026-07-19 02:20:14.144253+00
\.
...
23227	1	DEPARTAMENTO	TORRE A	1	4	ACTIVO
23228	1	DEPARTAMENTO	TORRE A	2	4	ACTIVO
23229	1	DEPARTAMENTO	TORRE A	3	4	ACTIVO
23230	1	DEPARTAMENTO	TORRE A	4	4	ACTIVO
23231	1	PISCINA	BLOQUE A	1	1	ACTIVO
\.
...
1	#BP-2026-0001	6	4	6	2026	2000.00	2026-07-19	PAGADO	6464646	Yape	uploads/voucher_1_1784427745924.jpg	2026-07-19
\.
...
1	6	23231	2026-07-19	TARDE	APROBADA	2026-07-19 02:32:41.741924+00
\.
...
2	luis_conserje	$2a$12$hnil8G.bdLfbn6DkeaR4durt6pTPplgCIDYGd4zW2v1JDF0U.l.DG	Luis	Gomez	luis.seguridad@habitech.com	955443322	CONSERJE	ACTIVO
3	ana_residente	$2a$12$hnil8G.bdLfbn6DkeaR4durt6pTPplgCIDYGd4zW2v1JDF0U.l.DG	Ana	Silva	ana.silva@outlook.com	911223344	RESIDENTE	ACTIVO
1	carlos_admin	$2a$12$gxoDZHW25xmYDVwIQz8sN.Tb56C8Qjf0.kx/lj3H7L/q4R4zpnLQa	Carlos	Mendoza	carlos@habitech.com	987654321	ADMIN_SISTEMA	ACTIVO
999	admin_test	$2a$10$wK9S4N0fV6/WnL0.XmOWhOm5nFEbWwYmGqCg8UvM9wM8xM7xM6xM.	Admin	Prueba	test@habitech.com	999999999	ADMIN_SISTEMA	INACTIVO
4	javier_admin	$2a$10$einRa8VVRzGF.aZI5VroXOBfS/TtJeahQob63C6cgZgtO1HZZ4ZPS	Javier	Mejia	javier@gmail.com	999888444	ADMIN_SISTEMA	ACTIVO
6	jose_residente	$2a$12$wppIPrJl0FfKoIshqpII4uZqufOyPF5Aq1gKfr7..VcRY8AZHukNa	Jose	Mejia	jose@gmail.com	987421530	RESIDENTE	ACTIVO
7	juan_conserje	$2a$12$hnGOsclPJ3GSPyRj.kVCVuhcXmQoEOKfDmrA5ZOmhcrUkanJTlNWC	Juan	Torres	juan@outlook.com	936857412	CONSERJE	ACTIVO
\.
...
1	1	4	Pedro	87144562		VISITA	2026-07-19 02:16:18.475629+00	2026-07-19 02:25:58.339701+00	FINALIZADO
\.
...
SELECT pg_catalog.setval('public.detalle_recibos_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.inventario_maestro_infraestructura_id_seq', 23231, true);
...
SELECT pg_catalog.setval('public.recibos_id_seq', 1, true);
...
CREATE UNIQUE INDEX uq_unidad_real_activa ON public.asignaciones USING btree (inventario_maestro_id, codigo_unidad_especifica) WHERE ((estado)::text = 'ACTIVO'::text);
...
\unrestrict 8bRhCDJzcdxGcV3eVeQ01zpZlOYFreLTu4ZrPZcbf5k8RiggJqU0hInj0v0s4eH
